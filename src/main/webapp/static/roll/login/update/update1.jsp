...
<table class="tableStyle" formMode="transparent" style="margin-top: 20px;">
		<tr> 
			...
			<td> 
				...
				<input type="hidden"  name="img.imgType" value="3"/>  
				<input type="hidden"  name="img.imgType2" value="0"/>   
			</td>
		</tr>
		<tr>
			<td colspan="2">
...
function closeWin(line) {        
	top.document.getElementById("_DialogFrame_a3").contentWindow.updateLine(line);
	top.Dialog.close();    
}
</script>
</body>
