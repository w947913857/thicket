    ...
    <div id="a4" class="index-charity">
        ...
        <div class="ic-left">
            <div class="il-one">  
                ...
                <p><a href="FoundDonations.jsp"><input type="submit" value="在线捐赠"></a></p>
            </div>
            <form action="DonationLove.jsp" method="post">
            <div class="il-two"> 
        ...
        <div class="ic-con">
            <p class="ckax"><img src="images/07.png">实时查看基金会总爱心金额</p>
            <p class="money">${moneyCountStr }</p>   
            <p><img src="images/jk_03.jpg"></p>
            <p class="xz"><span class="one"><a href="PLpublicity.jsp">捐款支出细则</a> </span><span class="two"><a href="FoundIndex.jsp">基金会简介</a> </span></p>
        </div>
        <div class="ic-right">
            <p>捐款方式 / pattern</p>
            <ul>
