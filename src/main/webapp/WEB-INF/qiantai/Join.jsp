...
<div class="yc-txdd">
    ...
    <div class="jm">
        <div class="jm-left">
            <p class="xx">
            	<c:if test="${sessionUser ==null }"><em style="font-size: 10px;color: red">加盟首先要登录哦，点击<a href="login.jsp?returnurl=/Join.jsp">登录</a><br/></em></c:if>
           ...
           <form method="post" action="<%=path %>/joins!saveJoins.action?update=${update }" id="joinsForm" onsubmit="return check();" enctype="multipart/form-data">
            <div class="tab">
            	...
            	<c:if test="${joins.phone !=null}"><input type="hidden"   name="joins.phone" value="${joins.phone }"/></c:if>
...
<div class="yj">
    <div class="yj-con">
        ...
        <div class="yj-right">
        <div class="yr-one">
             <img src="apk/orderclxj.png" width="94" height="94">
             <p>订房APP下载</p> 
        </div> 
        <div class="yr-one">
             <img src="apk/clxj.png" width="94" height="94">
             <p>丛林/闲居管理者APP下载</p>
        </div>
        <div class="yr-one"> 
            <img src="apk/car.png" width="94" height="94">
            <p>司机用车APP</p>
        </div>
        <div class="yr-one">
            <img src="images/index_42.jpg" width="94" height="94">
            <p>微信平台</p>
        </div>
    </div>
    </div>
