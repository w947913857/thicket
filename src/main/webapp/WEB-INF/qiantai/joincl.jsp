...
<div class="yc-txdd">
    ...
    <div class="kwff-p1">
     ...
     <div class="qzsqb-one">
               <ul> 
                  <li><a href="javascript:void(0)" onclick="goDownload('丛林加盟丛林闲居的合同.docx','1')">丛林加盟丛林闲居的合同</a> </li> 
                </ul> 
      </div>  
      </div>   
        <div class="jm-left">  
            <p class="xx">
            	<c:if test="${sessionUser ==null }"><em style="font-size: 10px;color: red">加盟首先要登录哦，点击<a href="login.jsp?returnurl=/joincl.jsp">登录</a><br/></em></c:if>
            	<img src="images/09.png">请填写加盟信息：
            	</p>
            <span class="rxxx">如果您是丛林，想加盟丛林闲居网，请填写如下信息（<i>* 为必填项</i>）</span>
           <form method="post" action="<%=path %>/joincl!addJoincl.action" id="joinclForm"  enctype="multipart/form-data">
            <div class="tab"> 
            	<!-- 用户id -->
            	<input type="hidden" name="joincl.uid" id="uid" value="${sessionUser.id }"/>
               <p><input type="text" value="${joincl.clname }" name="joincl.clname" id="name"  placeholder="寺院名称" class="lxr" ><i>*</i><span class="status" style="color: red" id="td1"></span><span class="status" style="color: red" id="td1"></span></p>
               <p><input type="text" value="${joincl.permitno }" name="joincl.permitno" id = "permitno"  placeholder="宗教场所许可证号" class="lxr " ><i>*</i><span class="status" style="color: red" id="td1"></span><span class="status" style="color: red" id="td2"></span></p>
               <p><input type="text" value="${joincl.address }" name="joincl.address" id="address" placeholder="地 址" class="lxr" ><i>*</i><span class="status" style="color: red" id="td1"></span><span class="status" style="color: red" id="td3"></span></p>
               <p><input type="text" value="${joincl.legalname }" name="joincl.legalname" id="legalname" placeholder="法人代表名字" class="lxr "><i>*</i><span class="status" style="color: red" id="td4"></span></p>
               <p><input type="text" value="${joincl.legalphone }" name="joincl.legalphone" id="legalphone" placeholder="法人代表手机号" class="lxr "><i>*</i><span class="status" style="color: red" id="td5"></span></p>
               <p><input type="text" value="${joincl.legalidcard }" name="joincl.legalidcard" id="legalidcard"  placeholder="法人代表身份证号" class="lxr "><i>*</i><span class="status" style="color: red" id="td6"></span></p>
               <p><input type="text" value="${joincl.contactsname }" name="joincl.contactsname" id="contactsname"  placeholder="联系人名字" class="lxr "><i>*</i><span class="status" style="color: red" id="td7"></span></p>
               <p><input type="text" value="${joincl.contactsmobile }" name="joincl.contactsmobile" id="contactsmobile"  placeholder="联系人固定电话（xxxx-xxxxxxx）" class="lxr "><i>*</i><span class="status" style="color: red" id="td8"></span></p>
               <c:if test="${joincl==null }">  
               <p><input type="text" maxlength="11" name="joincl.contactsphone" id="contactsphone"  placeholder="联系人手机（11位手机号码，作为后台管理员登录帐号）" class="lxr " onblur="checkContactsphone()"><i>*</i><span class="status" style="color: red" id="td9"></span></p>
               ...
               <p><input value="${joincl.postcode }" type="text" name="joincl.postcode" id="postcode"  placeholder="邮编" class="lxr "><i>*</i><span class="status" style="color: red" id="td11"></span></p>
               <p id="more"><input type="file" name="fileUrl.file0" ><i>合同上传&nbsp;&nbsp;&nbsp;*</i></p>
               <p><textarea  name="joincl.message" placeholder="寺院的简要介绍（500字以内）：">${joincl.message }</textarea></p>                
...
<div class="tcc2">     
    <div class="tx-ydm" style="margin-top: 300px;">  
            <p class="tx-sm"><span class="one"><img src="images/tx.png">提示</span><span class="two"><img src="images/14_01.png" class="close5"></span></p><br/><br/><br/>
            <p align="center"> 
