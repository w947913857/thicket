...
function loginOut(){
	window.location.href = "<%=path%>/reguser!loginOut.action?returnurl=/FoundIndex.jsp";
}
 </script>
        <!--首页轮播图-->
...
基金会善款的发放：<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;一、基金会资金的救助、扶助、帮助对象只限于向基金会捐过款的人士、社会团体以及给予过丛林闲居帮助过的单位；<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;二、基金会筹集的每一笔善款都透明公开，接受捐赠人的监督；<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;三、对每笔支出必须公示并按流程进行审批。
                    ...
                    <p class="jjh-arrow">  
                        <img src="images/arrow_03.jpg">
                    </p>
                    <p class="jyjs">活动图片</p>
                    <div class="hdtp">
                        <img src="images/hd1.jpg"><img src="images/hd2.jpg"><img src="images/hd3.jpg"><img src="images/hd4.jpg"><img src="images/hd5.jpg"> 
                        <img src="images/hd6.jpg"><img src="images/hd7.jpg"><img src="images/hd8.jpg"><img src="images/hd9.jpg"><img src="images/hd10.jpg">
                        <img src="images/hd11.jpg"><img src="images/hd12.jpg"><img src="images/hd13.jpg"><img src="images/hd14.jpg"><img src="images/hd15.jpg">
                    </div>
                </div>
