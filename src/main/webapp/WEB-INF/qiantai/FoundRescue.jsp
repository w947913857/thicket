        ...
        <div class="yc-txdd">
            ...
            <div class="jjh-index">
                <div class="jjh-index-left">
                    ...
                    <ul class="only-one">
                        <li><p class="yuan">1</p>
                            <p class="noyuan"><span><img src="<%=path %>/static/images/arrow1_03.jpg"></span>个人申请：困难群众在本网下载的江西济缘慈善基金会救助（扶助）《申请表》和《审批表》
                            </p></li>
                        <li><p class="yuan">2</p>
                            <p class="noyuan"><span><img src="<%=path %>/static/images/arrow1_03.jpg"></span>调查核实：由基金会事业部将初审符合救助（扶助）条件的困难群众材料与上报居委会（村）、街道（镇）进行调查核实，<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;金额较大的申请再由基金会派员实地调查核实，并形成调查意见，最后报基金会理事会通过
                            </p></li>
                        <li><p class="yuan">3</p>
                            <p class="noyuan"><span><img src="<%=path %>/static/images/arrow1_03.jpg"></span>社会公示：对申请并通过调查的救助对象由基金会采取网上公示等方式，广泛接受社会监督，如有举报、投诉情形的，再次<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;组织调查核实，以确保救助（扶助）工作的公开、公平和公正。公示时间一般为10个工作日
                            </p></li>
                        <li><p class="yuan">4</p>
                            <p class="noyuan"><span><img src="<%=path %>/static/images/arrow1_03.jpg"></span>理事会审定：由理事会根据审核和公示情况，最后审定救助（扶助）对象和金额
                            </p></li>
                        <li><p class="yuan">5</p>
                            <p class="noyuan"><span><img src="<%=path %>/static/images/arrow1_03.jpg"></span>公开发放：根据慈善救助（扶助）的范围、对象、标准，组织救助（扶助）对象举行发放仪式，请捐资人（代表）直接向救<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;助（扶助）对象发放慈善救助（扶助）金
                            </p></li>
                    </ul>
                    <div class="fzym-p1">
                            ...
                            <div class="fzym-table">
                                <div class="fzymt-one">
                                    ...
                                    <div class="ft-table1" style="margin-top:20px;">
                                        <p>
                                            <button type="button" value="提交信息" onclick="subHelp0()">提交信息</button>
                                        </p>
                                    </div>
                                </div>
                            </div>
