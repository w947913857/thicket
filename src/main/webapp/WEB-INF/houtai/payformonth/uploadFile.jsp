...
<!-- 表单异步提交end -->
  ...
  <body>
  	<form action='<%=path%>/payformonth!importData.action' target="frmright"  enctype='multipart/form-data' method='post' id='uplodFileForm'>
  	<input type="hidden" name="type" value="<%=request.getParameter("type") %>"/>
  	<input type="hidden" name="suffix" id="suffix"/>
  	<div class="padding_top20 padding_left25">
  	<table>
  		<tr>
  			<td><input type='file' id='payformonthDataFile' name='payformonthDataFile' showInfo="false"/></td>
  			<td>
  		...
  		<tr>
  			<td colspan="2"><a href="<%=path%>/payformonth/payformonth.xls" class="red underline">点击这里</a>下载导入的excel数据模板</td>
  		</tr>
  	</table>
  	</div>
	</form>
