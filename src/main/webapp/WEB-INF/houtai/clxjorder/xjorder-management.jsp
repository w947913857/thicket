		...
		grid = $("#dataBasic").quiGrid({
			columns:[
			  ...
			  //  { display: '下单id', name: 'state', 	 align: 'left',  wdith:"10%"} , 
			    { display: '闲居名称', name: 'clxjname', 	 align: 'align',  width:"12%"} ,  
			    { display: '闲居地址', name: 'clxjaddress', 	 align: 'align',  width:"12%"} ,  
			    { display: '闲居联系号码', name: 'clxjmobile', 	 align: 'align',  width:"10%"} ,
		 ...
		 url: '<%=path%>/clxjorder!getClxjorderOfId.action?type2=0&joinid='+'${loginedUser.id}', sortName: 'reservetime',rownumbers:true,
