...
<body>
	...
	<table class="tableStyle" formMode="transparent">
		...
		<tr>
			<td>所属部门：</td>
			<td><div class="selectTree validate[required]" selectedValue="" name="userinfor.organization.orgId" id="department" url="<%=path%>/organization!getDepartmentsTree.action" fillType="selectTree"></div><span class="star">*</span>	</td>
		</tr>
		<tr>
			<td>性别：</td>
			<td>
...
function initComplete(){
    ...
    $('#myFormId').submit(function(){ 
   	...
   	$.post("<%=path%>/users!preUpdateUserAjax.action",{"userinfor.userId":"<%=request.getParameter("userId")%>"},
			function(result){
