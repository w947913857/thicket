...
<script type="text/javascript"><!--
	...
	function initGrid() {
		grid = $("#dataBasic").quiGrid({
			columns:[ 
				{ display: '捐款人名字', name: 'donationname', 	 align: 'center', width: "10%"}, 
			    { display: '捐款金额', name: 'money', 	 align: 'center', width: "10%"},
			    { display: '捐款时间', name: 'donationtime', align: 'center', width: "13%"},  
		 ...
		 url: '<%=path%>/donation!getdonationOfPager.action', sortName: 'id',rownumbers:true, 
	...
	function onDelete(rowid,rowidx){
		top.Dialog.confirm("确定要删除该记录吗？",function(){
		  	//删除记录
		  	$.post("<%=path%>/donation!deleteDonation.action",
		  			{"ids":rowid},
		  			function(result){
