			...
			<div class="box2" panelTitle="查询" showStatus="false">
				...
				<table>
					<tr>
						<td>闲居户主名称：</td>
						<td>
							<input type="text" id="name" name="joinxj.xjname"/>
							<input type="text" style="width:2px;display:none;"/>
						</td>
						<td>加盟进度：</td>
						<td>
							<select name="joinxj.joinstatus" id="checktatus">
...
<script type="text/javascript">
	...
	function initGrid() {
		grid = $("#dataBasic").quiGrid({
			columns:[
				{ display: '闲居户主名称', name: 'xjname', 	 align: 'align', width: "10%"},
			    { display: '房屋产权证号', name: 'houseno', 	 align: 'align', width: "10%"},
			    { display: '邮编', name: 'postcode', align: 'align', width: "10%"},
			    { display: '户主身份证号', name: 'houseidcard', 	 align: 'align',  wdith:"10%"} ,
			    { display: '户主手机号', name: 'housephone', 	 align: 'align',  wdith:"10%"} , 
			    { display: '户主固定电话', name: 'housemobile', 	 align: 'align',  wdith:"10%"} ,
			    { display: '审核状态', name: 'joinstatus', 	 align: 'align',  wdith:"10%"} ,
			    { display: '申请日期', name: 'jointime', 	 align: 'align', width: "12%"},
		 ...
		 url: '<%=path%>/joinxj!selJoinxjOfPage.action', sortName: 'jointime',rownumbers:true, 
	...
	function onView(rowid){
		top.Dialog.open({
			URL:"<%=path%>/joinxj!getJoinxjOfId.action?joinxj.id=" + rowid,
			Title:"操作",Width:800,Height:420}); 
	}
	//修改	
