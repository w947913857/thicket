			...
			<div class="box2" panelTitle="查询" showStatus="false">
				...
				<table>
					<tr> 
						<td>加盟丛林名字：</td>
						<td>
							<input type="text" id="name" name="joincl.clname"/>
							<input type="text" style="width:2px;display:none;"/>
						</td>
						<td>加盟进度：</td>
						<td> 
							<select name="joincl.joinstatus" id="checktatus">
...
<script type="text/javascript">
	...
	function initGrid() {
		grid = $("#dataBasic").quiGrid({
			columns:[  
				 { display: '加盟丛林名字', name: 'clname', 	 align: 'align', width: "10%"},
				 { display: '宗教场所许可证号', name: 'permitno', 	 align: 'align', width: "10%"},
				 { display: '法人代表', name: 'legalname', 	 align: 'align', width: "10%"}, 
				 { display: '手机号', name: 'legalphone', 	 align: 'align', width: "10%"}, 
				 { display: '身份证号', name: 'legalidcard', 	 align: 'align', width: "10%"},
				 { display: '邮编', name: 'postcode', 	 align: 'align', width: "10%"},  
				 { display: '审核状态', name: 'joinstatus', 	 align: 'align', width: "8%"}, 
		 ...
		 url: '<%=path%>/joincl!selJoinclOfPage.action', sortName: 'jointime',rownumbers:true, 
	...
	function onView(rowid){
		top.Dialog.open({
			URL:"<%=path%>/joincl!getJoinclfoOfId.action?joincl.id=" + rowid,
