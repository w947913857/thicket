	...
	<form id="myFormId" action="<%=path%>/clxjmain!saveClxjmain.action"
		...
		<div class="box1" id="formContent" whiteBg="true">
			...
			<input type="hidden" name="clxjmain.joinid" value="${loginedUser.id}"/>
				<tr>
					...
					<td><input type="text"    placeholder="输入城市名" id="zmx" data-wholename="" >
						<input type="hidden" name="clxjmain.belongCity" id="city"/>
						 <!-- <input type="button" value="click" onclick="javascript:alert($('#zmx').attr('data-wholename'));"/>  -->
						</td>
				</tr>
				<tr> 
					<td>地址类型：</td>
				...
				--><tr>
					<td>寺院主持：</td> 
					<td><input type="text" name="clxjmain.abbot" class="validate[required]"/><span class="star">*</span></td>
					<td>开放时间：</td>
