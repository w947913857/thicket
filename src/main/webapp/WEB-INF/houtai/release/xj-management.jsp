			...
			<div class="box2" panelTitle="查询" showStatus="false">
				...
				<table>
					<tr>
						...
						<td>审核状态：</td>
						<td>
							<select name="clxjmain.checkStatus" id="checkStatus">
...
<script type="text/javascript">
	...
	function initGrid() {
		grid = $("#dataBasic").quiGrid({
			columns:[
			    ...
			    { display: '是否推荐', name: 'recommend', 	 align: 'left',  wdith:"20%"} , 
		 ...
		 url: '<%=path%>/clxjmain!getclxjmainOfPager.action?clxjmainJson.type2='+'0', sortName: 'id',rownumbers:true,checkbox:true,
	...
	function onView(rowid){
		top.Dialog.open({
			URL:"<%=path%>/clxjmain!getclxjmainOfId.action?isupdate=2&clxjmain.id=" + rowid,
