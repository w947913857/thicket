		...
		<td width="100%" class="ver01" >
			<div class="box2" panelTitle="查询" showStatus="false">
				...
				<table>        
					<tr>
						<td>求助姓名</td>
						<td><input type="text"  name="helpinfo.name"/></td>
						<td>审核状态：</td>
						<td>
							<select name="helpinfo.applystatus" >
								<option value="4">选择所有</option>
...
<script type="text/javascript">
	...
	function initGrid() {
		grid = $("#dataBasic").quiGrid({
			columns:[
				{ display: '求助姓名', name: 'name', 	 align: 'left', width: "10%"},
			    { display: '求助性别', name: 'sex', 	 align: 'left', width: "5%"},
			    { display: '求助年龄', name: 'age', align: 'left', width: "5%"},		   
			    { display: '家庭年收入', name: 'income', 	 align: 'left',  wdith:"5%"} ,
			    { display: '申请金额', name: 'applymoney', 	 align: 'left',  wdith:"10%"} ,	
			    { display: '主要困难', name: 'applycontent', align: 'left', width: "25%"},
			    { display: '享受低保', name: 'basicliving', 	 align: 'left',  wdith:"10%"} ,
			    { display: '申请类型', name: 'applytype', 	 align: 'left',  wdith:"10%"} ,			   		   
			    { display: '申请状态', name: 'applystatus', 	 align: 'left',  wdith:"10%"} ,
		 ...
		 url: '<%=path%>/helpfo!getHelpfoOfPager.action', sortName: 'id',rownumbers:true,checkbox:true,
	...
	function onView(rowid){
		top.Dialog.open({
			URL:"<%=path%>/helpfo!getHelpinfoOfId.action?isupdate=2&helpinfo.id=" + rowid,
